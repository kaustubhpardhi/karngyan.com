...
export default {
  ...
  skilledIn: {
    ...
    meta: [
      ...
      { name: "node", src: "/images/node2.png" },
      {
        name: "postgres",
        src: "/images/postgres3.png"
      },
      {
        name: "mongodb",
  ...
  strings: {
    en_US: {
      ...
      hero: {
        ...
        description:
          "An alchemist of backend engineering, I delight in sculpting products from ideation to infinite scalability, With an insatiable appetite for robustness.",
      ...
      recommendations: {
        header: "projects",
        subtext: "checkout some cool stuff"
      }
    }
  }
};
