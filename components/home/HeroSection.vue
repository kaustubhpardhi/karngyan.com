          ...
          <div data-aos="zoom-in" class="lg:grid lg:grid-cols-12">
            ...
            >
              <div>
                ...
                <h3
                  class="mt-4 text-3xl tracking-tight font-extrabold text-indigo-600 sm:mt-5 sm:leading-none lg:mt-6 lg:text-3xl xl:text-3xl"
                >
                  <span class="md:block">Kaustubh Pardhi</span>
                </h3>
                <h1
                ...
                >
                  <div
                    class="flex flex-wrap space-x-1 items-start items-center space-x-4 md:space-x-3"
                  >
                    <div
                      v-for="(firm, index) in $config.skilledIn.meta"
                      :key="index"
                    >
                      <a
                        :href="firm.url"
