  ...
  >
    ...
    >
      <ProjectCard
        ...
        v-for="project in projectsByTechs"
        :key="project.slug"
        :project="project"
      />
    </div>
    <p class="mt-8 px-4  text-sm leading-7 text-gray-400">
      find more cool stuff on my github , click on the icon below.
    </p>
  </div>
</template>
  ...
  computed: {
    ...
    projectsByTechs() {
      ...
      return this.projects.filter(project =>
        project.tech.includes(this.currentTech)
      );
    }
  },
  data() {
